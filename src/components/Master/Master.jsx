...
const MasterPage = ({ masterData, setMasterData, setLoading }) => {
  const navigate = useNavigate();
  
  const masterRecords = [
    { id: 1, title: "Category", value: "1,245" },
    { id: 2, title: "Item", value: "543" },
    { id: 3, title: "Item Code", value: "87" },
    { id: 4, title: "Shade", value: "234" },
    { id: 5, title: "Brand", value: "3,890" },
    { id: 6, title: "Quality", value: "987" },
    { id: 7, title: "Unit", value: "156" },
    { id: 8, title: "Range", value: "2,345" },
    { id: 9, title: "Size", value: "78" },
    { id: 10, title: "Item Type", value: "45" },
  ];
  ...
  const handleCardClick = (title) => {
    ...
    // Add more conditions here for other cards if needed
  };

  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 py-6 px-4 sm:px-6 md:px-8 relative overflow-hidden">
